...
#define LCD_BACKLIGHT(x)                                                       \
  PORTD = (x) ? (PORTD | (1 << PD0)) : (PORTD & ~(1 << PD0))
...
void LCD_Fill(unsigned char xs, unsigned char ys, unsigned char w,
              unsigned char h, int color);
void LCD_Box(unsigned char x1, unsigned char y1, unsigned char x2,
             unsigned char y2, unsigned char fill, int color);
void LCD_Char(char ch, unsigned char x, unsigned char y, int fcolor,
              int bcolor);
void LCD_String(char *the_string, unsigned char x, unsigned char y, int fcolor,
                int bcolor);
void LCD_Line(unsigned char x1, unsigned char y1, unsigned char x2,
              unsigned char y2, int color);
void LCD_Circle(unsigned char center_x, unsigned char center_y,
                unsigned char rad, int color);
void LCD_Bitmap(unsigned char start_x, unsigned char start_y,
                unsigned char h_size, unsigned char v_size,
