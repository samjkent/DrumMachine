...
GPIO_TypeDef *key_ports[8] = {GPIOJ, GPIOF, GPIOC, GPIOJ, GPIOF, GPIOJ, GPIOC, GPIOC};
uint16_t key_pins[8]  = {GPIO_PIN_3, GPIO_PIN_7, GPIO_PIN_8, GPIO_PIN_0, GPIO_PIN_6, GPIO_PIN_1, GPIO_PIN_6, GPIO_PIN_7};
